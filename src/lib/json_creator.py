...
test_json = create_json_from_regex(test_regex_output)
...
test_algorithm_output = {"pack0": ["int baz", "int bar", "int foo"], "pack1": ["int baz", "int bar", "int foo"]}
...
print(convert_json_to_function(test_algorithm_output))
