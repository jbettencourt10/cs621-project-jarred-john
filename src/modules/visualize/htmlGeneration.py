...
class Visualizer:
    ...
    def visualize(self):
        ...
        self.buildAndSaveGraph(oldData,"image1")
        self.buildAndSaveGraph(newData,"image2")
    ...
    def generateReport(self, originalData, newData, packedParams):
        ...
        output = template.render(originalParamList=originalParamList, packedParams=packedParams, occurenceDict=occurenceDict, functionsDict=functionsDict
                                )
